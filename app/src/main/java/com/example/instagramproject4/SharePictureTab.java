...
public class SharePictureTab extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        imgShareImage.setOnClickListener(SharePictureTab.this);
            ...
            case R.id.btnShareImage:
                ...
                if (recievedImageBitmap !=  null){
                    ...
                    if (edtDescription.getText().toString().equals("")){
                        ...
                        FancyToast.makeText(getContext(),"Error: You must type description. ", Toast.LENGTH_SHORT,FancyToast.ERROR,true).show();
                        ...
                        parseObject.saveInBackground(new SaveCallback() {
                            ...
                            public void done(ParseException e) {
                                if (e== null) {
                                    ...
                                    FancyToast.makeText(getContext(),"Unknown error",Toast.LENGTH_SHORT, FancyToast.SUCCESS,true).show();
...
//        FancyToast.makeText(getContext(), "Now we can access the images", Toast.LENGTH_SHORT,FancyToast.SUCCESS,true).show();
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
      ...
      try {
          ...
          imgShareImage.setImageBitmap(recievedImageBitmap);
